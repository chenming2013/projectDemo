	...
	<body>
		<fieldset style="width: 500px;">
			...
			<form action="${pageContext.request.contextPath}/FormServlet" method="post">
				...
				编&nbsp;&nbsp;号(文本框)： <input type="text" name="userid" placeholder="编号" value="" size="2" maxlength="2"><br>
				<!--输入文本框，通过value指定其显示的默认值-->
				用户名(文本框)：<input type="text" name="username" placeholder="用户名" value=""><br>
				<!--密码框，其中所有输入的内容都以密文的形式显示-->
				密&nbsp;&nbsp;码(密码框)：
				<!--&nbsp;表示的是一个空格-->
				<input type="password" name="userpass" placeholder="密码" value=""><br>
				<!--单选按钮，通过checked指定默认选中，名称必须一样，其中value为真正需要的内容-->
				性&nbsp;&nbsp;别(单选框)： <input type="radio" name="sex" value="male">男
				...
				<input type="checkbox" name="inst" value="游泳">游泳 <input
					...
					type="checkbox" name="inst" value="编程" checked>编程 <input
					type="checkbox" name="inst" value="上网">上网 <br>
				<!--大文本输入框，宽度为34列，高度为5行-->
				说&nbsp;&nbsp;明(文本域)：
