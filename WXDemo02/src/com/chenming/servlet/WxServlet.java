...
import com.chenming.util.MessageHandlerUtil;
...
public class WxServlet extends HttpServlet{
     ...
     * 比如这里我将Token设置为cm_weixin
     */
    private final String TOKEN = "cm_weixin";

    /**
     * 处理微信服务器发来的消息,微信发来的其他任何消息都通过这个方法
     */
    ...
    /**
     * 接入请求,微信会发送接入请求到这个方法来验证我们服务器的有效性
     * 确认请求来自微信服务器
     */
